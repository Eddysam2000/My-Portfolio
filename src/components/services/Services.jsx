       ...
       <article className="service">
        ...
        <article className="service">
          ...
          <ul className='service_list'>
            ...
            <li>
              <BiCheck className='service_list-icon'/>
              <p>Testing and debugging code to ensure functionality.</p>
            </li>
            <li>
              <BiCheck className='service_list-icon'/>
              <p>Conducting Algorithmic analysis.</p>
            </li>
            <li>
              <BiCheck className='service_list-icon'/>
              <p>Designing efficient data structures and algorithms.</p>
            </li>
            <li>
              <BiCheck className='service_list-icon'/>
            ...
            <li>
              <BiCheck className='service_list-icon'/>
              <p>Works with developers to join algorithms into applications.</p>
            </li>
          </ul>
        </article>
